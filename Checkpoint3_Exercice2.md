...
Appuyer sur Ctrl + O, puis appuyez sur la touche Entrée pour enregistrer les modifications.    

Appuyer sur Ctrl + X pour quitter l'éditeur de texte nano.    
...
- Plusieurs tentatives sont répétées sur le même port, indiquant peut-être une tentative de force brute ou une mauvaise configuration.   
